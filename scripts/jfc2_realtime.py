...
fig, ax = plt.subplots(nrows=5, ncols=3, figsize=(10,7), sharex=True)
ax = ax.ravel()
...
plt.savefig("/media/x/cosmicsense/git/misc/wuestebach/crnsmonitor.png", dpi=300, bbox_inches="tight")
